#ifndef CVX_IMGPROC_CONCOMP_HPP
#define CVX_IMGPROC_CONCOMP_HPP
...
public:
    ...
    unsigned int label() const { return it_->second.label_; }
...
private:
    ...
    typedef std::map<unsigned int, RegionData> ContainerType ;
