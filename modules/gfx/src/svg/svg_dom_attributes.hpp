#ifndef CVX_GFX_SVG_DOM_ATTRIBUTES_HPP
#define CVX_GFX_SVG_DOM_ATTRIBUTES_HPP
...
using cvx::gfx::Path ;
using cvx::gfx::Point2d ;
using cvx::gfx::Matrix2d ;
...
template<typename T>
inline void parseOptionalAttribute(const char *name, const cvx::util::Dictionary &attr, OptionalAttribute<T> &t) {
