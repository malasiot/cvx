#ifndef CVX_GFX_SVG_DOM_HPP
#define CVX_GFX_SVG_DOM_HPP
...
public:
    ...
    void setDocument(cvx::gfx::SVGDocument *doc) { root_ = doc ; }

    cvx::gfx::SVGDocument &document() { return *root_;}
