...
void RenderingContext::setPaint(Element &e)
{
    ...
    if ( fill_paint.type() == PaintType::None ) ;
        ...
        if ( fill_rule == FillRule::NonZero )
            brush.setFillRule(cvx::gfx::FillRule::NonZero) ;
        else
            brush.setFillRule(cvx::gfx::FillRule::EvenOdd) ;
...
void RenderingContext::applyClipPath(ClipPathElement *cp)
{
    ...
    ImageSurface is(canvas_.surface().width(), canvas_.surface().height()) ;
    ...
    if ( cp->style().getClipRule() == ClipRule::EvenOdd )
        fr = cvx::gfx::FillRule::EvenOdd ;
    else
        fr = cvx::gfx::FillRule::NonZero ;
...
Font RenderingContext::makeFont(const Style &st)
{
    ...
    case FontStyle::Oblique:
        f.setStyle(cvx::gfx::FontStyle::Oblique) ;
        break ;
    case FontStyle::Italic:
        f.setStyle(cvx::gfx::FontStyle::Italic) ;
        break ;
    case FontStyle::Normal:
        f.setStyle(cvx::gfx::FontStyle::Normal) ;
        break ;
    }
    ...
    case FontWeight::W400:
        f.setWeight(cvx::gfx::FontWeight::Normal) ;
        break ;
    ...
    case FontWeight::W900:
        f.setWeight(cvx::gfx::FontWeight::Bold) ;
        break ;
    }
